      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="glass-card rounded-[2.5rem] p-12 md:p-20 text-center relative overflow-hidden border border-white/10">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <p className="text-lg text-slate-400 mb-10 max-w-xl font-light">
              Join elite research institutions using Assertion Engine to validate, secure, and accelerate their discovery pipelines.
            </p>
            
            <button 
              onClick={onStart}
              className="bg-emerald-500 text-slate-950 px-10 py-5 rounded-full font-bold text-lg transition-all hover:scale-105 hover:shadow-2xl flex items-center gap-2 group"
            >
              Get Started Now
